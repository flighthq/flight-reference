...
class App extends Sprite {
  ...
  public constructor() {
    ...
    this.spriteSheet = Assets.getBitmapData('openfl/images/nyancat.png');
...
manifest.addBitmapData('openfl/images/nyancat.png');

AssetLibrary.loadFromManifest(manifest)
  .onComplete((library) => {
    Assets.registerLibrary('default', library);

    const stage = new Stage(STAGE_WIDTH, STAGE_HEIGHT, 0xffffff, App, { allowHighDPI: true });
