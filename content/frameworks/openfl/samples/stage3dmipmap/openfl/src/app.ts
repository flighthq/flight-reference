...
class App extends Sprite {
  ...
  private initialize(): void {
    ...
    this.texture = this.context3D.createTexture(
  ...
  private updateViewMatrix(): void {
    this.cameraLinearVelocity.z = this.calculateUpdatedVelocity(
      this.cameraLinearVelocity.z,
      this.cameraLinearAcceleration,
      App.MAX_FORWARD_VELOCITY,
    );
    this.cameraRotationVelocity = this.calculateUpdatedVelocity(
      this.cameraRotationVelocity,
      this.cameraRotationAcceleration,
      App.MAX_ROTATION_VELOCITY,
    );

    this.cameraWorldTransform.appendRotation(
      this.cameraRotationVelocity,
      Vector3D.Y_AXIS,
      this.cameraWorldTransform.position,
    );
  ...
  private stage3D_onContext3DCreate = (event: Event): void => {
    BitmapData.loadFromFile('openfl/images/checkers.png')
