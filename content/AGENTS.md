...
For example, `content/frameworks/openfl/functional/node-alpha/openfl` and `content/frameworks/openfl/functional/node-alpha/flight` are peer implementations of the same OpenFL functional case.
