...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      'motion/Actuate': resolve(repoRoot, 'node_modules/actuate/lib/motion/Actuate.js'),
      'motion/easing/Elastic': resolve(repoRoot, 'node_modules/actuate/lib/motion/easing/Elastic.js'),
      'motion/easing/Quad': resolve(repoRoot, 'node_modules/actuate/lib/motion/easing/Quad.js'),
